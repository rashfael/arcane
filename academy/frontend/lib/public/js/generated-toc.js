...
generated_toc = {
  generate: function() {
    ...
    if (status && status == "open") {
      ...
      toggle_initially = "Inhaltsverzeichnis für diese Seite ausblenden";
    } else {
      display_initially = "none";
      toggle_initially = "Inhaltsverzeichnis für diese Seite einblenden";
    }
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = 'Inhaltsverzeichnis für diese Seite ' + (d == 'block' ? 'ein' : 'aus') + 'blenden';
